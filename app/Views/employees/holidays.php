    ...
    <div class="row align-items-center">
      <div class="col">
        <div class="mt-5">
          ...
          <a href="add-holiday.html" class="btn btn-primary float-right veiwbutton">Add Holiday</a>
        </div>
      </div>
    </div>
  </div>
                  ...
                  <td class="text-right">
                    <div class="dropdown dropdown-action">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="edit-holiday.html"><i class="fas fa-pencil-alt m-r-5"></i>
                          Edit</a>
