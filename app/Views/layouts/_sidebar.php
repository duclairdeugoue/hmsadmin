    ...
    <div id="sidebar-menu" class="sidebar-menu">
      <ul>
        ...
        <li class="submenu"> <a href="<?= base_url() ?>/employees"><i class="fas fa-user"></i> <span> Employees </span> <span class="menu-arrow"></span></a>
          <ul class="submenu_class" style="display: none;">
            <li><a class="<?php if (url_is('/employess/list')) : ?>active<?php endif ?>" href="<?= base_url() ?>/employees/list">Employees List </a></li>
            <li><a class="<?php if (url_is('/employess/leaves')) : ?>active<?php endif ?>" href="<?= base_url() ?>/employees/leaves">Leaves </a></li>
            <li><a class="<?php if (url_is('/employess/holidays')) : ?>active<?php endif ?>" href="<?= base_url() ?>/employees/holidays">Holidays </a></li>
            <li><a class="<?php if (url_is('/employess/attendance')) : ?>active<?php endif ?>" href="<?= base_url() ?>/employees/attendance">Attendance </a></li>
          </ul>
        </li>
